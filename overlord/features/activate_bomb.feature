Feature: Activate the bomb
  ...
  Scenario: Reach activation page (happy)
  ...
  Scenario: Bomb does not activate when wrong activation code is entered (sad)
    Given the bomb has been booted with the default codes
